        ...
        <div class="content">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Form edit berita</h3>
                ...
                <div class="block-content">
                    <form action="{{route('admin.berita.update', $berita->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="judul" name="judul" placeholder="Product.." value="{{ $berita->judul }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="js-select2 form-control" id="headline" name="headline" data-placeholder="Choose one..">
                                    ...
                                    <option value="1" {{($berita->headline == 1) ? 'selected' : '' }}>True</option>
                                    <option value="0" {{($berita->headline == 0) ? 'selected' : '' }}>False</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="6" placeholder="Deskripsi..">{{ $berita->deskripsi }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12">Gambar File Input</label>
                            <div class="col-12">
                                <img src="{{asset('assets/media/berita/'.$berita->gambar)}}" class=" border bg-secondary" style="max-width: 500px">
                            </div>
                            <div class="col-8">
